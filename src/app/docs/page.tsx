    ...
    <div className="min-h-screen bg-white">
      <nav className="border-b border-[#e5e5e5] bg-white">
        <div className="max-w-[1200px] mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <span className="text-sm font-medium text-[#737373]">Documentation</span>
        </div>
      </nav>
      ...
      <div className="max-w-[1000px] mx-auto px-6 py-12 flex gap-8">
        <nav className="w-56 shrink-0">
          {sections.map((section) => (
            <div key={section.title} className="mb-6">
              <h3 className="text-xs font-semibold text-[#737373] uppercase tracking-wider mb-2">{section.title}</h3>
              <ul className="space-y-1">
                {section.items.map((item) => (
                  <li key={item.label}>
                    <a href={item.href} className="block text-sm text-[#525252] hover:text-[#0a0a0a] py-0.5">
                      {item.label}
                    </a>
                  </li>
                ))}
        ...
        <div className="flex-1 min-w-0 prose prose-sm max-w-none">
          <h1 className="text-2xl font-semibold text-[#0a0a0a]" id="what-is">What is WebCore?</h1>
          ...
          <h2 className="text-lg font-semibold text-[#0a0a0a] mt-10" id="quick-start">Quick Start</h2>
          <p className="text-sm text-[#525252] leading-relaxed">
          ...
          <h2 className="text-lg font-semibold text-[#0a0a0a] mt-10" id="scores">Understanding Scores</h2>
          <p className="text-sm text-[#525252] leading-relaxed">
          ...
          <h2 className="text-lg font-semibold text-[#0a0a0a] mt-10" id="api-auth">API Authentication</h2>
          <p className="text-sm text-[#525252] leading-relaxed">
            Use your API key in the <code className="text-[10px] bg-[#f5f5f5] px-1 py-0.5 rounded">x-api-key</code> header.
