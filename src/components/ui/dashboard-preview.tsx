    ...
    return (
      <div className="p-6 sm:p-10 flex items-center justify-center min-h-[200px] sm:min-h-[280px]">
        <div className="text-center">
          <Shield size={32} className="mx-auto text-neutral-600" strokeWidth={1} />
          <p className="mt-3 text-sm text-neutral-400 font-medium">Dashboard Preview</p>
          <p className="mt-1 text-xs text-neutral-500">Comprehensive scan results at a glance</p>
        </div>
      </div>
    )
  }
