    ...
    <span
      className={cn(
        ...
        size === "md" && "px-3 py-1.5 text-xs",
        {
          ...
          "bg-[#f5f5f5] dark:bg-neutral-800 text-[#525252] dark:text-neutral-300": variant === "default",
          "bg-[#dcfce7] dark:bg-[#16a34a]/20 text-[#16a34a]": variant === "success",
          "bg-[#fee2e2] dark:bg-[#dc2626]/20 text-[#dc2626]": variant === "error",
          "bg-[#fef3c7] dark:bg-[#d97706]/20 text-[#d97706]": variant === "warning",
        },
